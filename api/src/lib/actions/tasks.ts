 ...
 *
 * Ordering (`move`, `reorder`), arrangement claims and step editing. Those are
 * driven by a pointer against a rendered list and have no meaning to a
 * sentence like "finish the bank thing" — extracting them would be motion
 * without a caller. They stay in the route until something outside the UI
 * needs them.
 */
...
import {
  tasks, taskActivity, areas, projects, BUCKETS, PRIORITIES,
} from '../../db/schema.js';
